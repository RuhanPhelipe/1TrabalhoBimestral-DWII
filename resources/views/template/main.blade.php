...
<body>
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-primary-color">
        <div class="container-fluid">
            <a href="{{route('index')}}" class="navbar-brand">
                <img src="{{asset('img/natureza.png')}}" width="64" height="64">
                <span class="ms-3 fs-5 fw-bold text-dark">Jaguatiricas</span>
            </a>
            <button class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#itens">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" class="bi bi-menu-button-wide" viewBox="0 0 16 16">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="{{route('material.index')}}" class="dropdown-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000000" class="bi bi-box-fill" viewBox="0 0 16 16">
    ...
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-8 d-flex justify-content-center">
                <span class="text-dark fs-4 fw-bold">{{ mb_strtoupper($submenu, 'UTF-8'); }}</span>
            </div>
...
<nav class="navbar fixed-bottom navbar-dark">
    <div class="container-fluid">
        <span class="text-blask fw-regular"><b>Projeto Multidisciplinar:</b> Biologia II + Desenvolvimento Web</span>
    </div>
</nav>
